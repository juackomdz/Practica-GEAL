<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioAdmin.aspx.cs" Inherits="Geal2.InicioAdmin" %>
...
<head>
    ...
    <link rel="stylesheet" href="css/estiloinicioadmin.css">
    <link rel="stylesheet" href="css/estilobarra.css">
</head>

<body class="text-center" id="bodyinicioadmin">
   ...
   <nav class="navbar navbar-light navbar-expand-lg fixed-top">
    ...
    <h1 id="TituloInicioAdmin"><br>Bienvenido Administrador<br></h1>
    <p id="parrafoinicioadmin">En este sitio podrás agregar, eliminar o actualizar la información que quieras.</p>
