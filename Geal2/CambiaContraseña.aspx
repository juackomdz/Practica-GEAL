<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiaContraseña.aspx.cs" Inherits="Geal2.CambiaContraseña" %>
...
<head>
    ...
    <link href="css/EstiloCambiarContraseña.css" rel="stylesheet" />
...
<body id="bodyCam">
        ...
        <div class="container-fluid">
            ...
            <div
                ...
                <ul class="nav navbar-nav mx-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link text-center" href="CambiaContraseña.aspx" style="color:#00a3d8;">Cambiar Clave</a></li>
                </ul>
    ...
    <div id="formCont" class="contact-clean">
        <form method="post" style="background-color: rgba(255,255,255,0.58); margin-top:80px;" runat="server">
            <h2 class="text-center">Cambio de Contraseña</h2>
            <div class="form-group"><asp:TextBox class="form-control" type="password" name="name" placeholder="Clave Actual" runat="server" ID="txt_claveactual"/></div>
            <div class="form-group"><asp:TextBox class="form-control" type="password" name="name" placeholder="Clave Nueva" runat="server" ID="txt_clavenueva"/></div>
            <div class="form-group"><asp:TextBox class="form-control" type="password" name="name" placeholder="Repetir Clave Nueva" runat="server" ID="txt_claverepetida"/></div>
            <div class="form-group text-center"><asp:Button class="btn btn-warning active" runat="server" type="submit" id="btn_cambiar1" OnClick="btn_cambiar1_Click" Text="Cambiar"/></div>
